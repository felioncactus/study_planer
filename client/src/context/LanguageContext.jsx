...
const SUPPLEMENTAL_PHRASES = {
  ru: {
    "Update your profile, email, and avatar — or delete your account.": "Обновите профиль, почту и аватар — или удалите аккаунт.",
    "Update your profile, email, and avatar â€” or delete your account.": "Обновите профиль, почту и аватар — или удалите аккаунт.",
    "Avatar": "Аватар",
    "Choose file": "Выбрать файл",
    "Saved.": "Сохранено.",
    "Useful weekly insight from your tasks, calendar blocks, and AI-generated analysis.": "Полезная недельная аналитика по задачам, календарю и AI-анализу.",
    "Loading statistics…": "Загрузка статистики…",
    "Loading statisticsâ€¦": "Загрузка статистики…",
    "Completion rate": "Процент выполнения",
    "done / total tasks": "выполнено / всего задач",
    "Overdue rate": "Процент просрочки",
    "needs cleanup": "нужно разобрать",
    "Task time (7d)": "Время задач (7 дн.)",
    "Activity time (7d)": "Время активностей (7 дн.)",
    "scheduled blocks": "запланированные блоки",
    "fixed events": "фиксированные события",
    "AI insight": "AI-аналитика",
    "What matters most right now": "Что сейчас важнее всего",
    "Highlighted insight": "Главный вывод",
    "Snapshot": "Сводка",
    "Current task pressure": "Текущая нагрузка задач",
    "Total tasks": "Всего задач",
    "Done": "Выполнено",
    "Due next 7 days": "На ближайшие 7 дней",
    "Avg open task": "Средняя открытая задача",
    "Daily completed trend": "Тренд выполненных задач",
    "Recent task movement": "Недавняя динамика задач",
    "No recent completions yet.": "Пока нет недавних выполнений.",
    "Scheduled study load": "Учебная нагрузка",
    "Task block minutes over the last 7 days": "Минуты блоков задач за последние 7 дней",
    "Courses needing attention": "Курсы, требующие внимания",
    "Sorted by open work": "Сортировка по открытой работе",
    "Activity load": "Нагрузка активностей",
    "Fixed activity minutes over the last 7 days": "Минуты фиксированных активностей за последние 7 дней",
    "No recent task blocks yet.": "Пока нет недавних блоков задач.",
    "No course-linked tasks yet.": "Пока нет задач, связанных с курсами.",
    "No recent activities yet.": "Пока нет недавних активностей.",
    "Pick a conversation, start a direct chat, or open your self notes.": "Выберите чат, начните личный чат или откройте заметки себе.",
    "Type here...": "Введите сообщение...",
    "Paste or attach files and images": "Вставьте или прикрепите файлы и изображения",
    "This conversation is empty.": "В этой беседе пока пусто.",
    "Send a message, paste an image, ask the bot, or create a poll to get things moving.": "Отправьте сообщение, вставьте изображение, спросите бота или создайте опрос.",
    "Start tasks directly from reminders in this thread": "Запускайте задачи прямо из напоминаний в этой ветке",
    "Send message": "Отправить сообщение",
    "Timetable": "Расписание",
    "Loading timetable…": "Загрузка расписания…",
    "Loading timetableâ€¦": "Загрузка расписания…",
    "Nothing scheduled for this day yet.": "На этот день пока ничего не запланировано.",
    "No all-day items for this date.": "На эту дату нет событий на весь день.",
    "A simplified schedule view for small screens.": "Упрощенный вид расписания для маленьких экранов.",
    "Course": "Курс",
    "Task due": "Срок задачи",
    "Task block": "Блок задачи",
    "Other": "Другое",
    "Checking events...": "Проверка событий...",
    ...
    "Sun": "Вс",
    "Create activity": "Создать активность",
    "Use manual times or let the planner suggest a slot.": "Укажите время вручную или позвольте планировщику предложить слот.",
    "Activities now use the same rounded time-picking flow as task planning, with exact manual start and end times.": "Активности используют такой же выбор времени, как планирование задач, с точным ручным началом и окончанием.",
    "Loading planner...": "Загрузка планировщика...",
    "Your activities": "Ваши активности",
    "No activities yet.": "Пока нет активностей.",
    "saved blocks": "сохраненных блоков",
    "saved block": "сохраненный блок",
    "Nothing due this week 🎉": "На этой неделе ничего не нужно сдавать 🎉",
    "Add a task (or set due dates) so your dashboard stays helpful.": "Добавьте задачу или сроки, чтобы панель оставалась полезной.",
    "Add task": "Добавить задачу",
    "Manage courses": "Управлять курсами",
    "No courses yet": "Курсов пока нет",
    "Create a course to start organizing tasks and schedules.": "Создайте курс, чтобы начать организовывать задачи и расписание.",
  },
  ko: {
    "Update your profile, email, and avatar — or delete your account.": "프로필, 이메일, 아바타를 수정하거나 계정을 삭제하세요.",
    "Update your profile, email, and avatar â€” or delete your account.": "프로필, 이메일, 아바타를 수정하거나 계정을 삭제하세요.",
    "Avatar": "아바타",
    "Choose file": "파일 선택",
    "Saved.": "저장되었습니다.",
    "Useful weekly insight from your tasks, calendar blocks, and AI-generated analysis.": "작업, 캘린더 블록, AI 분석에서 얻은 주간 인사이트입니다.",
    "Loading statistics…": "통계를 불러오는 중…",
    "Loading statisticsâ€¦": "통계를 불러오는 중…",
    "Completion rate": "완료율",
    "done / total tasks": "완료 / 전체 작업",
    "Overdue rate": "기한 초과율",
    "needs cleanup": "정리 필요",
    "Task time (7d)": "작업 시간 (7일)",
    "Activity time (7d)": "활동 시간 (7일)",
    "scheduled blocks": "예약된 블록",
    "fixed events": "고정 이벤트",
    "AI insight": "AI 인사이트",
    "What matters most right now": "지금 가장 중요한 것",
    "Highlighted insight": "주요 인사이트",
    "Snapshot": "요약",
    "Current task pressure": "현재 작업 부담",
    "Total tasks": "전체 작업",
    "Done": "완료",
    "Due next 7 days": "7일 내 마감",
    "Avg open task": "평균 열린 작업",
    "Daily completed trend": "일별 완료 추세",
    "Recent task movement": "최근 작업 흐름",
    "No recent completions yet.": "최근 완료가 아직 없습니다.",
    "Scheduled study load": "예약된 학습량",
    "Task block minutes over the last 7 days": "최근 7일 작업 블록 시간",
    "Courses needing attention": "주의가 필요한 강의",
    "Sorted by open work": "열린 작업순 정렬",
    "Activity load": "활동량",
    "Fixed activity minutes over the last 7 days": "최근 7일 고정 활동 시간",
    "No recent task blocks yet.": "최근 작업 블록이 아직 없습니다.",
    "No course-linked tasks yet.": "강의와 연결된 작업이 아직 없습니다.",
    "No recent activities yet.": "최근 활동이 아직 없습니다.",
    "Pick a conversation, start a direct chat, or open your self notes.": "대화를 선택하거나 직접 채팅을 시작하거나 내 메모를 여세요.",
    "Type here...": "여기에 입력하세요...",
    "Paste or attach files and images": "파일과 이미지를 붙여넣거나 첨부하세요",
    "This conversation is empty.": "이 대화는 비어 있습니다.",
    "Send a message, paste an image, ask the bot, or create a poll to get things moving.": "메시지를 보내거나 이미지를 붙여넣고, 봇에게 묻거나 투표를 만드세요.",
    "Start tasks directly from reminders in this thread": "이 스레드의 알림에서 바로 작업을 시작하세요",
    "Send message": "메시지 보내기",
    "Timetable": "시간표",
    "Loading timetable…": "시간표를 불러오는 중…",
    "Loading timetableâ€¦": "시간표를 불러오는 중…",
    "Nothing scheduled for this day yet.": "이 날에는 아직 일정이 없습니다.",
    "No all-day items for this date.": "이 날짜에는 종일 항목이 없습니다.",
    "A simplified schedule view for small screens.": "작은 화면용 간단 일정 보기입니다.",
    "Course": "강의",
    "Task due": "작업 마감",
    "Task block": "작업 블록",
    "Other": "기타",
    "Checking events...": "이벤트 확인 중...",
    "No events.": "이벤트가 없습니다.",
    "Event": "이벤트",
    "Mon": "월",
    "Tue": "화",
    ...
    "saved blocks": "저장된 블록",
    "saved block": "저장된 블록",
    "Nothing due this week 🎉": "이번 주 마감 항목이 없습니다 🎉",
    "Add a task (or set due dates) so your dashboard stays helpful.": "대시보드가 유용하도록 작업이나 마감일을 추가하세요.",
    "Add task": "작업 추가",
    "Manage courses": "강의 관리",
  },
  kk: {
    "Update your profile, email, and avatar — or delete your account.": "Профильді, email мен аватарды жаңартыңыз немесе аккаунтты жойыңыз.",
    "Update your profile, email, and avatar â€” or delete your account.": "Профильді, email мен аватарды жаңартыңыз немесе аккаунтты жойыңыз.",
    "Avatar": "Аватар",
    "Choose file": "Файл таңдау",
    "Saved.": "Сақталды.",
    "Useful weekly insight from your tasks, calendar blocks, and AI-generated analysis.": "Тапсырмалар, күнтізбе блоктары және AI талдауы бойынша апталық түсінік.",
    "Loading statistics…": "Статистика жүктелуде…",
    "Loading statisticsâ€¦": "Статистика жүктелуде…",
    "Completion rate": "Аяқтау пайызы",
    "done / total tasks": "орындалған / барлық тапсырма",
    "Overdue rate": "Кешігу пайызы",
    "needs cleanup": "реттеу қажет",
    "Task time (7d)": "Тапсырма уақыты (7 күн)",
    "Activity time (7d)": "Іс-шара уақыты (7 күн)",
    "scheduled blocks": "жоспарланған блоктар",
    "fixed events": "тұрақты іс-шаралар",
    "AI insight": "AI талдауы",
    "What matters most right now": "Қазір ең маңыздысы",
    "Highlighted insight": "Негізгі қорытынды",
    "Snapshot": "Қысқаша шолу",
    "Current task pressure": "Қазіргі тапсырма жүктемесі",
    "Total tasks": "Барлық тапсырмалар",
    "Done": "Орындалды",
    "Due next 7 days": "Келесі 7 күнде",
    "Avg open task": "Орташа ашық тапсырма",
    "Daily completed trend": "Күндік аяқтау тренді",
    "Recent task movement": "Соңғы тапсырма қозғалысы",
    "No recent completions yet.": "Жақында аяқталған тапсырма жоқ.",
    "Scheduled study load": "Жоспарланған оқу жүктемесі",
    "Task block minutes over the last 7 days": "Соңғы 7 күндегі тапсырма блоктары",
    "Courses needing attention": "Назар қажет курстар",
    "Sorted by open work": "Ашық жұмыс бойынша сұрыпталған",
    "Activity load": "Іс-шара жүктемесі",
    "Fixed activity minutes over the last 7 days": "Соңғы 7 күндегі тұрақты іс-шара минуттары",
    "Pick a conversation, start a direct chat, or open your self notes.": "Чатты таңдаңыз, жеке чат бастаңыз немесе өз жазбаларыңызды ашыңыз.",
    "Type here...": "Осында жазыңыз...",
    "Paste or attach files and images": "Файлдар мен суреттерді қойыңыз немесе тіркеңіз",
    "Timetable": "Кесте",
    "Nothing scheduled for this day yet.": "Бұл күнге әлі ештеңе жоспарланбаған.",
    "No events.": "Оқиға жоқ.",
    "Nothing due this week 🎉": "Осы аптада тапсыратын ештеңе жоқ 🎉",
    "Add a task (or set due dates) so your dashboard stays helpful.": "Панель пайдалы болуы үшін тапсырма немесе мерзім қосыңыз.",
    "Add task": "Тапсырма қосу",
    "Manage courses": "Курстарды басқару",
  },
  uz: {
    "Update your profile, email, and avatar — or delete your account.": "Profil, email va avatarni yangilang yoki akkauntni o'chiring.",
    "Update your profile, email, and avatar â€” or delete your account.": "Profil, email va avatarni yangilang yoki akkauntni o'chiring.",
    "Avatar": "Avatar",
    "Choose file": "Fayl tanlash",
    "Saved.": "Saqlandi.",
    "Useful weekly insight from your tasks, calendar blocks, and AI-generated analysis.": "Vazifalar, kalendar bloklari va AI tahlilidan haftalik xulosa.",
    "Loading statistics…": "Statistika yuklanmoqda…",
    "Loading statisticsâ€¦": "Statistika yuklanmoqda…",
    "Completion rate": "Bajarilish foizi",
    "done / total tasks": "bajarilgan / jami vazifalar",
    "Overdue rate": "Kechikish foizi",
    "needs cleanup": "tartiblash kerak",
    "Task time (7d)": "Vazifa vaqti (7 kun)",
    "Activity time (7d)": "Faoliyat vaqti (7 kun)",
    "scheduled blocks": "rejalangan bloklar",
    "fixed events": "doimiy tadbirlar",
    "AI insight": "AI xulosasi",
    "What matters most right now": "Hozir eng muhim narsa",
    "Highlighted insight": "Asosiy xulosa",
    "Snapshot": "Qisqa ko'rinish",
    "Current task pressure": "Joriy vazifa bosimi",
    "Total tasks": "Jami vazifalar",
    "Done": "Bajarilgan",
    "Due next 7 days": "Keyingi 7 kunda",
    "Avg open task": "O'rtacha ochiq vazifa",
    "Daily completed trend": "Kunlik bajarilish trendi",
    "Recent task movement": "So'nggi vazifa harakati",
    "No recent completions yet.": "Hozircha yaqinda bajarilganlar yo'q.",
    "Scheduled study load": "Rejalangan o'qish yuklamasi",
    "Task block minutes over the last 7 days": "So'nggi 7 kundagi vazifa bloklari",
    "Courses needing attention": "E'tibor kerak kurslar",
    "Sorted by open work": "Ochiq ish bo'yicha saralangan",
    "Activity load": "Faoliyat yuklamasi",
    "Fixed activity minutes over the last 7 days": "So'nggi 7 kundagi doimiy faoliyat daqiqalari",
    "Pick a conversation, start a direct chat, or open your self notes.": "Suhbatni tanlang, shaxsiy chat boshlang yoki o'z yozuvlaringizni oching.",
    "Type here...": "Shu yerga yozing...",
    "Paste or attach files and images": "Fayl va rasmlarni joylang yoki biriktiring",
    "Timetable": "Jadval",
    "Nothing scheduled for this day yet.": "Bu kunga hali hech narsa rejalashtirilmagan.",
    "No events.": "Tadbirlar yo'q.",
    "Nothing due this week 🎉": "Bu hafta topshiriladigan narsa yo'q 🎉",
    "Add a task (or set due dates) so your dashboard stays helpful.": "Panel foydali bo'lishi uchun vazifa yoki muddat qo'shing.",
...
const DYNAMIC_PHRASES = {
  ru: {
    ...
    "Group timer finished": "Групповой таймер завершён",
    "A chat timer has ended": "Таймер чата завершён",
    "Open chat": "Открыть чат",
    "coming up": "скоро",
    at: "в",
    "Study assistant welcome": "Привет! Я могу помочь:\n• добавить задачи\n• спланировать неделю\n• сказать, что нужно сдать\n\nПопробуйте: **Добавь задание по математике на 2 часа к пятнице, затем спланируй мою неделю.**",
    "Study assistant": "Учебный ассистент",
    "Study assistant panel": "Панель учебного ассистента",
    "Open assistant": "Открыть ассистента",
    "Close assistant": "Закрыть ассистента",
    "Tasks, planning, reminders": "Задачи, планирование, напоминания",
    "Markdown like bold, italic, lists, and code renders here.": "Здесь поддерживаются Markdown: жирный, курсив, списки и код.",
    "Ask about tasks, due dates, or your week...": "Спросите о задачах, сроках или неделе...",
    "Thinking...": "Думаю...",
    "Basic settings": "Основные настройки",
    "Delete course": "Удалить курс",
    "Course begins": "Начало курса",
    "Course ends": "Конец курса",
    "Midterm date": "Дата промежуточного экзамена",
    "Final date": "Дата финального экзамена",
    "Course image": "Изображение курса",
    "No file chosen": "Файл не выбран",
    "Banner image": "Баннер",
    "Plan this task": "Запланировать задачу",
    "Plan this activity": "Запланировать активность",
    "Green = fits in one session • Red = too busy": "Зеленый = помещается в один сеанс • Красный = слишком занято",
    "Pick a clean time slot first, then save the activity.": "Сначала выберите свободный слот, затем сохраните активность.",
    "Planning window": "Окно планирования",
    "Study window": "Учебное окно",
    Window: "Окно",
    to: "до",
    Apply: "Применить",
    "Best time windows and AI": "Лучшие окна и AI",
    "Suggested windows and AI": "Предложенные окна и AI",
    "Best time windows": "Лучшие окна",
    "Suggested windows": "Предложенные окна",
    "No free time inside your study window.": "Нет свободного времени в учебном окне.",
    "No free time inside this planning window.": "Нет свободного времени в этом окне планирования.",
    "AI week rearrange": "AI-перестройка недели",
    "AI arrange week": "AI спланирует неделю",
    "If it looks like there is no good time, ask AI to fit it into your week (or split it into parts).": "Если хорошего времени нет, попросите AI встроить это в неделю или разделить на части.",
    "Ask AI to place this activity into the best slot or split the plan when needed.": "Попросите AI поставить активность в лучший слот или разделить план.",
    "Planning...": "Планирую...",
    "Use this plan": "Использовать этот план",
    "Use first slot": "Использовать первый слот",
    "A time plan is selected. Open to review or change it.": "План времени выбран. Откройте, чтобы проверить или изменить.",
    "Tip: picked time creates a calendar block. You can still change task status later.": "Совет: выбранное время создаст блок в календаре. Статус задачи можно изменить позже.",
    "The picked time becomes a fixed activity block on your calendar.": "Выбранное время станет фиксированным блоком активности в календаре.",
    ...
    "Working...": "Работаю...",
    "Ask me to improve grammar, fix spelling, write an outline, summarize the lesson, or rewrite sections.": "Попросите улучшить грамматику, исправить ошибки, написать план, кратко пересказать урок или переписать фрагменты.",
    "Fix grammar in this lesson, make an outline, improve clarity, summarize key points...": "Исправь грамматику, составь план, улучши ясность, кратко выдели главное...",
  },
  ko: {
    open: "열림",
    more: "개 더",
    ...
    Block: "블록",
    "New message": "새 메시지",
    "New message from": "새 메시지 보낸 사람:",
    "You received a new message": "새 메시지를 받았습니다",
    Reply: "답장",
    "Close notification": "알림 닫기",
    "Group timer finished": "그룹 타이머 종료",
    "A chat timer has ended": "채팅 타이머가 종료되었습니다",
    "Open chat": "채팅 열기",
    "coming up": "예정",
    at: "오",
    "Study assistant welcome": "안녕하세요! 도와드릴 수 있어요:\n• 작업 추가\n• 주간 일정 계획\n• 마감 항목 확인\n\n예: **금요일까지 2시간짜리 수학 과제를 추가하고, 내 주를 계획해 줘.**",
    "Study assistant": "학습 도우미",
    "Tasks, planning, reminders": "작업, 계획, 알림",
    "Basic settings": "기본 설정",
    "Delete course": "강의 삭제",
    "Course begins": "강의 시작",
    "Course ends": "강의 종료",
    "Midterm date": "중간고사 날짜",
    "Final date": "기말고사 날짜",
    "Course image": "강의 이미지",
    "Plan this task": "작업 계획",
    "Plan this activity": "활동 계획",
    "Planning window": "계획 시간대",
    "Best time windows": "최적 시간대",
    "Suggested windows": "추천 시간대",
    "AI arrange week": "AI 주간 배치",
    "AI assistant": "AI 도우미",
    "Back to course": "강의로 돌아가기",
    "Ask assistant": "도우미에게 묻기",
  },
  kk: {
    open: "ашық",
    more: "тағы",
    ...
    Begins: "Басталуы",
    Ends: "Аяқталуы",
    Midterm: "Аралық емтихан",
    Final: "Қорытынды",
    Next: "Келесі",
    "← Previous": "← Алдыңғы",
    Block: "Блок",
    "New message": "Жаңа хабарлама",
    "New message from": "Жаңа хабарлама жіберген:",
    "You received a new message": "Сізге жаңа хабарлама келді",
    Reply: "Жауап беру",
    "Close notification": "Хабарламаны жабу",
    "Group timer finished": "Топ таймері аяқталды",
    "A chat timer has ended": "Чат таймері аяқталды",
    "Open chat": "Чатты ашу",
    "coming up": "жақында",
    at: "сағ.",
    "Study assistant welcome": "Сәлем! Мен көмектесе аламын:\n• тапсырмалар қосу\n• аптаны жоспарлау\n• мерзімдерді айту\n\nМысал: **Жұмаға дейін 2 сағаттық математика тапсырмасын қосып, аптаны жоспарла.**",
    "Study assistant": "Оқу көмекшісі",
    "Tasks, planning, reminders": "Тапсырмалар, жоспарлау, ескертулер",
    "Basic settings": "Негізгі баптаулар",
    "Delete course": "Курсты жою",
    "Course begins": "Курс басталуы",
    "Course ends": "Курс аяқталуы",
    "Midterm date": "Аралық емтихан күні",
    "Final date": "Қорытынды күні",
    "Course image": "Курс суреті",
    "Plan this task": "Тапсырманы жоспарлау",
    "Plan this activity": "Іс-шараны жоспарлау",
    "Planning window": "Жоспарлау уақыты",
    "Best time windows": "Ең жақсы уақыттар",
    "Suggested windows": "Ұсынылған уақыттар",
    "AI arrange week": "AI аптаны жоспарласын",
    "AI assistant": "AI көмекші",
    "Back to course": "Курсқа оралу",
    "Ask assistant": "Көмекшіден сұрау",
  },
  uz: {
    open: "ochiq",
    more: "yana",
    ...
    "New message from": "Yangi xabar yuborgan:",
    "You received a new message": "Sizga yangi xabar keldi",
    Reply: "Javob berish",
    "Close notification": "Bildirishnomani yopish",
    "Group timer finished": "Guruh taymeri tugadi",
    "A chat timer has ended": "Chat taymeri tugadi",
    "Open chat": "Chatni ochish",
    "coming up": "yaqinlashmoqda",
    at: "soat",
    "Study assistant welcome": "Salom! Men yordam bera olaman:\n• vazifalar qo'shish\n• haftani rejalash\n• muddatlarni aytish\n\nMasalan: **Jumagacha 2 soatlik matematika topshirig'ini qo'sh, keyin haftamni rejalashtir.**",
    "Study assistant": "O'quv yordamchisi",
    "Tasks, planning, reminders": "Vazifalar, rejalash, eslatmalar",
    "Basic settings": "Asosiy sozlamalar",
    "Delete course": "Kursni o'chirish",
    "Course begins": "Kurs boshlanishi",
    "Course ends": "Kurs tugashi",
    "Midterm date": "Oraliq imtihon sanasi",
    "Final date": "Yakuniy imtihon sanasi",
    "Course image": "Kurs rasmi",
    "Plan this task": "Vazifani rejalash",
    "Plan this activity": "Faoliyatni rejalash",
    "Planning window": "Rejalash oynasi",
    "Best time windows": "Eng yaxshi vaqtlar",
    "Suggested windows": "Tavsiya etilgan vaqtlar",
    "AI arrange week": "AI haftani joylashtirsin",
    "AI assistant": "AI yordamchi",
    "Back to course": "Kursga qaytish",
    "Ask assistant": "Yordamchidan so'rash",
  },
};
...
function getDictionary(language) {
  return { ...(PHRASES[language] || {}), ...(EXTRA_PHRASES[language] || {}), ...(SUPPLEMENTAL_PHRASES[language] || {}), ...(DYNAMIC_PHRASES[language] || {}) };
}

function getAllTranslatedValues() {
  const values = [];
  for (const language of LANGUAGES.map((item) => item.code).filter((code) => code !== "en")) {
    values.push(...Object.values(getDictionary(language)));
  }
...
export function LanguageProvider({ children }) {
  ...
  useEffect(() => {
    ...
    const translatedValues = language === "en" ? getAllTranslatedValues() : new Set(Object.values(dictionary).map(normalize));
